...
public
  ...
  def search
    if params[:searchfield].to_s == "any"
    	searchquery = "( labnumber LIKE '%"+params[:searchtext].to_s+"%' OR partnumber LIKE '%"+params[:searchtext].to_s+"%' OR serialnumber LIKE '%"+params[:searchtext].to_s+"%' OR name LIKE '%"+params[:searchtext].to_s+"%') "
    else
